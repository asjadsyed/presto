...
import static com.facebook.presto.utils.QueryExecutionClientUtil.getTaskInfo;
...
public class TestDistributedTaskInfoResource
{
    ...
    @Test(timeOut = 220_000, invocationCount = 3)
            ...
            throws Exception
    {
        ...
        for (TaskInfo actualTaskInfo : coordinator2.getTaskManager().getAllTaskInfo()) {
            TaskId actualTaskId = actualTaskInfo.getTaskId();
            TaskInfo proxiedTaskInfo = getTaskInfo(client, coordinator2, "/v1/taskInfo/" + actualTaskId);
